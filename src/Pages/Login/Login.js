					...
					<div className='w-full px-6 py-8 md:px-8 lg:w-1/2'>
						<div class='flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow  sm:px-6 md:px-8 lg:px-10'>
							...
							<div class='flex gap-4 item-center'>
								<button class='py-2 px-4 flex justify-center items-center  bg-blue-600 hover:bg-blue-700 focus:ring-blue-500 focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg '>
									<svg
										width='20'
										height='20'
										fill='currentColor'
								...
								<button class='py-2 px-4 flex justify-center items-center  bg-red-600 hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg '>
									<svg
										width='20'
										height='20'
										fill='currentColor'
									...
									<div class='flex items-center mb-6 -mt-4'>
										<div class='flex items-center justify-evenly'>
											<label className='label cursor-pointer '>
												...
												/>
												<span className='label-text mr-2 lg:mr-4 ml-1 '>
													Terms & Conditions
												</span>
											</label>
							...
							<div class='flex items-center justify-center mt-6'>
								...
								>
									<span class='ml-2'>
										...
										<span className='underline underline-offset-2 text-blue-600 font-bold ml-2'>
											Sign Up
										</span>
									</span>
								</Link>
